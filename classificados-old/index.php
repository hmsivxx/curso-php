...
?>
    ...
    <div class="container">
        <div class="jumbotron mt-4">
            ...
            <p class="lead">There is <?php echo $totalUsers; ?> stoners registered</p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                ...
                <table class="table table-striped">
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <img src="assets/images/offers/<?php echo $imgTemp; ?>" height="50">
                                </td>
                                <td>
                                    <a href="product.php?id=<?php echo $offer['id'] ?>"><?php echo $offer['title']; ?></a><br>
                ...
                <ul class="pagination">
                    ...
                    <li class="page-item <?php if($page == $i){echo 'active';} ?>"><a href="index.php?<?php echo $i;?>" class="page-link"><?php echo $i; ?></a></li>
                    <?php endfor; ?>
                </ul>
            </div>
        </div>
